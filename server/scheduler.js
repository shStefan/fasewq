...
cron.schedule('3 14 * * *', async () => {
  console.log('⏰ Executing scheduled post at 14:03');
...
cron.schedule('5 14 * * *', async () => {
  console.log('⏰ Executing scheduled post at 14:05');
  await postNextArticle();
}, {
  timezone: "Asia/Makassar"
});
...
cron.schedule('7 14 * * *', async () => {
  console.log('⏰ Executing scheduled post at 14:07');
  await postNextArticle();
}, {
  timezone: "Asia/Makassar"
});

// Refresh articles at 14:09
cron.schedule('9 14 * * *', async () => {
  console.log('⏰ Executing scheduled refresh at 14:09');
